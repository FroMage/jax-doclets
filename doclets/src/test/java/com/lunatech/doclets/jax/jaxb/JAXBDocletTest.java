...
public class JAXBDocletTest {
	...
	public void testStart() throws IOException {
		...
		RootDocImpl rootDocImpl = javadocTool.getRootDocImpl("en", "", new ModifierFilter(ModifierFilter.ALL_ACCESS), javaNames.toList(), options.toList(), false, packageNames.toList(), excludedPackages.toList(), false, false, false);
