...
public class RequestHeaderTaglet implements Taglet {

  public static final String NAME = "ResponseHeader";

  private static final String HEADER = "HTTP response headers:";
