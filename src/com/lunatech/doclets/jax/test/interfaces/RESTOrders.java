...
public interface RESTOrders {
	...
	@Path("/orders")
	@GET
	public Response getOrders(@QueryParam("creator") String creatorKey,
	...
	@Path("/order/{key}")
	@PUT
	public Response putOrder(@PathParam("key") final String orderKey,
			Order order, @Context UriInfo uriInfo);
	...
	@Path("/order/{key}/comments")
	@POST
	public Response postOrderComments(@PathParam("key") final String orderKey,
			Comment comment);
	...
	@Path("/order/{key}/lines")
	@POST
	public Response postOrderLines(@PathParam("key") final String orderKey,
			OrderLine orderLine);
	...
	@Path("/order/{key}/statuses")
	@POST
	public Response postOrderStatuses(@PathParam("key") final String orderKey,
	...
	@Path("/order/{key}/consignments")
	@POST
	public Response postOrderConsignments(
			@PathParam("key") final String orderKey, ResourceLink consignment);
	...
	@GET
	public Response getOrderAttachment(@PathParam("key") final String orderKey,
			@PathParam("name") String name, @Context Request request);
	...
	@GET
	@Produces("*/*")
	public Response getOrderAttachmentData(
			@PathParam("key") final String orderKey,
	...
	@GET
	@Produces("*/*")
	public Response getOrderAttachmentThumbnail(
			@PathParam("key") final String orderKey,
			@PathParam("name") String name);
